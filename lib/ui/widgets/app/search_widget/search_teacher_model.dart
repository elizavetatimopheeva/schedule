...
//   void onTeacherTap(BuildContext context, int index){
//     final urlId =_filteredTeachers[index].urlId;
//      Navigator.of(
//       context,
//     ).pushNamed(MainNavigationRouteNames.mainTeacher, arguments: urlId);
//   }
...
//     } else {
//       isSearchingTeachers = true;
//       _filteredTeachers = _allTeachers.where((teachers) {
//         return teachers.firstName.toLowerCase().contains(searchQuery.toLowerCase())||teachers.lastName.toLowerCase().contains(searchQuery.toLowerCase());
//       }).toList();
//     }
//     _searchQuery = searchQuery.isEmpty ? null : searchQuery;
//     notifyListeners();
...
// class SearchTeacherModelProvider extends InheritedNotifier {
//   final SearchTeacherModel model;

//   const SearchTeacherModelProvider({
//     Key? key,
//     required this.model,
...
//   static SearchTeacherModelProvider? watch(BuildContext context) {
//     return context
//         .dependOnInheritedWidgetOfExactType<SearchTeacherModelProvider>();
//   }

//   static SearchTeacherModelProvider? read(BuildContext context) {
//     final widget = context
//         .getElementForInheritedWidgetOfExactType<SearchTeacherModelProvider>()
//         ?.widget;
//     return widget is SearchTeacherModelProvider ? widget : null;
//   }

//   @override
//   bool updateShouldNotify(SearchTeacherModelProvider oldWidget) {
//     return true;
//   }
// }